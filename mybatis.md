...
+ 它支持**定制化的SQL**、**存储过程**，以及**高级映射**
+ MyBatis **几乎避免了所有的JDBC代码**
+ MyBatis 可以**使用简单的XML或注解**来配置和映射原生类型、接口和Java的POJO为数据库的记录
+ MyBatis 最早是apache的一个开源项目**iBatis**，2010年这个项目由apache software foundation 迁移到了google code，并改名为MyBatis
+ 2013年11月迁移到Github
